...
/* Overall intensity.
   ...
   The whole effect is additive light. Against the light theme's near-white
   glass there is very little headroom left to add to, so everything is pulled
   well down and the effect becomes a faint iridescence rather than a glow. */
const TONE = { gain: 0.55, rim: 0.42, glow: 0.34 };
