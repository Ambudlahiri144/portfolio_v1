/* ------------------------------------------------------------------
   The dark theme's share of the root layout.
   ...
   The light theme has its own copy at src/themes/light/layout.tsx with
...
import { site } from "@dark/lib/site";
import DockNav from "@dark/components/Docknav";
import SmoothScroll from "@dark/components/SmoothScroll";
import "./theme.css";
import { cn } from "@dark/lib/utils";
