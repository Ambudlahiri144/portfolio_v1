...
/* Overall intensity.
   ...
   The whole effect is additive light. Against the near-black dock of the dark
   theme it reads as molten metal, so it runs at full strength here. */
const TONE = { gain: 1.0, rim: 1.0, glow: 1.0 };
